...
NumConstraintGradAvail = 0; % Gradients of constraints not available
budget = [100; 1000; 3000; 10000; 30000];%alter computing time as needed
ObjBd = NaN;
OptimalSol = NaN;
...
if (NumStartingSol < 0) || (NumStartingSol ~= round(NumStartingSol)) || (seed <= 0) || (round(seed) ~= seed),
    ...
    elseif (NumStartingSol == 1),
        ...
        StartingSol = [unifrnd(700, 1000, NumStartingSol, 1), unifrnd(1500, 2000, NumStartingSol, 1)]; % Each row is uniformly distributed in its dimension
